...
public class BallWorldComponent extends JComponent
{
	...
	/**
	 * Constructs a component for rendering the given ball environment on the GUI.
	 * 
	 * @param world
	 */
	 ...
	 * area.
	 * 
	 * @param g2 the graphics area on which to draw
	...
	/**
	 * Displays an error message explaining that the Ball's color/shape was null so
	 * it could not be drawn. Show the message only once per component.
	 */
	 ...
	 */
	public class BallWorldMouseHandler implements MouseMotionListener, MouseListener
	{
		@Override
		public void mouseClicked(MouseEvent e)
		{
			Ball nearestBall = BallWorldComponent.this.world.nearestBall(e.getPoint());
			if (nearestBall != null)
			{
