...
public interface BallEnvironment
{
	 ...
	 * 
	 * @param ball the ball to add, must not be null
	 */
	...
	/**
	 * Checks whether the given point is within the vertical extents of this world.
	 * Ignores the horizontal location of the point.
	 * 
	 * @param point
